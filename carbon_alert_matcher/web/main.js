...
async function get_alerts() {
		...
		var match_similar = document.getElementById("matchSimilar").checked;
		...
		let org_data = await eel.get_alerts(match_similar, cb_analytics, watchlists, usb_device_control, host_based_firewall, intrusion_detection_system, containers_runtime)();
